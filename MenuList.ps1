function Show-Menu
{
  <#
      .SYNOPSIS
      A script to display a List of PS Scripts and links to run them.
      .DESCRIPTION
      Shows a selection window from the computer running the script and shows a list of scripts to run
      .EXAMPLE
      Show-Menu
      .RETURNS
      displays List and then runs the chosen script.
  #>
  ...
  $Form.text                       = "Script Selection"
  $Form.TopMost                    = $true
  $Form.AutoScroll                 = $true

  $topTitle1                       = New-Object -TypeName system.Windows.Forms.Label
  $topTitle1.text                  = "Script Name"
  $topTitle1.AutoSize              = $true
  $topTitle1.width                 = 25
  $topTitle1.height                = 10
  $topTitle1.location              = New-Object -TypeName System.Drawing.Point -ArgumentList (16,11)
  $topTitle1.Font                  = New-Object -TypeName System.Drawing.Font -ArgumentList ('Microsoft Sans Serif',10)
  
  $topTitle2                       = New-Object -TypeName system.Windows.Forms.Label
  $topTitle2.text                  = "Script Description"
  $topTitle2.AutoSize              = $true
  $topTitle2.width                 = 25
  $topTitle2.height                = 10
  $topTitle2.location              = New-Object -TypeName System.Drawing.Point -ArgumentList (106,11)
  $topTitle2.Font                  = New-Object -TypeName System.Drawing.Font -ArgumentList ('Microsoft Sans Serif',10)
  ...
  $Form.controls.AddRange(@($topTitle1, $TopTitle2, $location,$Label2,$createFolder,$structureLocation,$Label4,$Groupbox1,$Groupbox2))
